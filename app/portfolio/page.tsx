    ...
    <>
      ...
      <Section>
        <div className="mx-auto max-w-5xl grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
          {companies.map((c) => (
            <div key={c.name} className="card p-5 md:p-6 glowable group h-full">
              <div className="relative aspect-video rounded-lg mb-3 md:mb-4 flex items-center justify-center bg-black overflow-hidden">
                <img
                  src={(c as any).logo}
                  alt={`${c.name} logo`}
              ...
              <h3 className="font-serif text-base md:text-lg t-strong mb-1 md:mb-2">
                {c.name}
              </h3>
